...
import { SocialTrollBox } from './SocialTrollBox'
...
export default function TrollBox() {
  // Show enhanced social trollbox if Supabase auth is enabled
  if (ENABLE_SUPABASE_AUTH) {
    return <SocialTrollBox />
  }
  
  // Otherwise show original trollbox
  return <OriginalTrollBox />
}
