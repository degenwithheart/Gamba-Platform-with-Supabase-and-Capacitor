...
// clientCache will be imported dynamically to avoid circular import during constants evaluation
 ...
 */
// TOKEN_METADATA_FETCHER is provided from `src/services/tokenMetadataFetcher.ts` when available.
...
/** 
 * SUPABASE AUTHENTICATION FEATURE FLAG
...
export const ENABLE_MOBILE_APP = false // Enable mobile app auto-sync after builds

/**
 * Feature flags for optional systems copied from DegenCasino
 * These are disabled by default.
 */
export const ENABLE_CACHE_SYSTEM = true
export const ENABLE_COMPREHENSIVE_ERROR_SYSTEM = true
