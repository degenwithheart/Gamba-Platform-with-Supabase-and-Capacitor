...
import lazyWithPreload from '../lib/lazyLoad'
...
export const GAMES: ExtendedGameBundle[] = [
  ...
  app: lazyWithPreload(() => import('./Dice')),
  },
  {
    id: 'slots',
    meta: {
  ...
  app: lazyWithPreload(() => import('./Slots')),
  },
  {
    id: 'flip',
    meta: {
  ...
  app: lazyWithPreload(() => import('./Flip')),
  },
  {
    id: 'hilo',
    meta: {
    ...
    props: { logo: '/logo.svg' },
  app: lazyWithPreload(() => import('./HiLo')),
  },
  {
    id: 'mines',
    meta: {
  ...
  app: lazyWithPreload(() => import('./Mines')),
  },
  {
    id: 'roulette',
    meta: {
  ...
  app: lazyWithPreload(() => import('./Roulette')),
  },
  {
    id: 'plinko',
    meta: {
  ...
  app: lazyWithPreload(() => import('./Plinko')),
  },
  {
    id: 'crash',
    meta: {
  ...
  app: lazyWithPreload(() => import('./CrashGame')),
  },
  {
    id: 'blackjack',
    meta: {
  ...
  app: lazyWithPreload(() => import('./BlackJack')),
  },
  {
    id: 'jackpot',
    meta: {
  ...
  app: lazyWithPreload(() => import('./Jackpot')),
  },
  {
    id: 'plinkorace',
    meta: {
  ...
  app: lazyWithPreload(() => import('./PlinkoRace')),
  },
  {
    id: 'pvpflip',
    meta: {
  ...
  app: lazyWithPreload(() => import('./PvpFlip')),
  },
];
