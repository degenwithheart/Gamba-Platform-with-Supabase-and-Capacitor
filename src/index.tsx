...
import TOKEN_METADATA_FETCHER from './services/tokenMetadataFetcher'
import installGlobalErrorReporting from './services/globalErrorReporter'
// ...existing code...
import './styles.css'

const root = ReactDOM.createRoot(document.getElementById('root')!)
// Install global client error reporting early
try { installGlobalErrorReporting() } catch (e) { console.warn('Failed to install global error reporting', e) }
